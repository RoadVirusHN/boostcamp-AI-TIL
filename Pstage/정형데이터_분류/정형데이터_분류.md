...
![스케일 방법에 따른 분포 변화](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414010708292.png)
...
![Log transformation 결과(우)](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414011019451.png)
...
![Scaling+분포 변경의 효과로 인한 상관관계 변화](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414011601364.png)

![Quantile transformation에 의한 성능 향상](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414011821659.png)

이러한 분포 변화를 통해 상관관계를 변경할 수 있다.

**Binning**

![다봉분포의 연속형 변수와 범주형으로 변경(Binning)](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414011916919.png)
...
> 출처: ![image-20210414012816676](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414012816676.png)
...
![One hot encoding의 예시, 기르고 있는 애완동물](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414012414604.png)
...
![Label encoding의 예시](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414012756381.png)
...
3. Frequency encoding
   ...
   ![frequency encoding의 예시](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414013038213.png)
...
![Tagrget encoding의 예시](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414013137888.png)
...
![긴 글로 이루어진 description의 수치화](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414014021051.png)

문자열같은 경우 내용이 길어 수치화 하기 힘들며, Word2Vec과 같은 알고리즘으로 수치화할 수 있다.

### 결측치 처리 

![결측치가 존재하는 데이터](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414014807777.png)

결측치는 위와 같이 NaN, 즉 측정하지 못하거나 손실 등의 여러 이유로 값이 존재하지 않는 경우를 의미한다.

**pattern(결측치의 패턴 파악)**

![image-20210414015458315](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414015458315.png)

위와 같이 (흰색의 비어있는 부분이 결측치) 결측치의 생성은 랜덤한 경우와 일정한 패턴이 있는 경우로 나눠진다.

![결측치가 랜덤으로 비는 경우](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414020132423.png)

보통은 위와 같이 결측치의 패턴이 존재하지 않는 경우가 대부분이며 이때는 단변량이나 다변량 결측치 삽입을 사용해야한다.

![결측치의 패턴이 존재하는 경우](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414020108273.png)
...
![Missing data rule](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414020306784.png)
...
![평균 삽입 방식의 단점](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414022008709.png)
...
![결측치 비율에 따른 결과값과의 상관관계 변화 (파랑: 결측치 채우기 전 상관관계, 주황: 결측치 채운 후 상관관계)](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414022559605.png)
...
![Multivariate 방식의 결측치 채운 뒤의 상관관계 변화](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414023004255.png)
...
![합리적 접근법의 예시](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414023223182.png)

다른 곳에서 데이터를 구하거나, 다른 변수를 통해서 구할 수 있다.

### 이상치 처리

![이상치의 예시](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414023405694.png)
...
![이상치 처리 방법에 따른 성능 비교](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414024840929.png)
...
![image-20210414154237653](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414154237653.png)
...
![Validation acc와 Train acc의 비교](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414155943969.png)
...
![Validation 성능이 떨어지려는 순간부터 Stop](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414162230781.png)

Training data와 비교하여 Validation 성능이 떨어지려할 때 멈추는 방법

- Parameter norm penalty

![penalty에 따른 fitting 결과 그래프](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414162342630.png)
...
![SMOTE의 예시 ](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414162654693.png)

> ![image-20210414162802544](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414162802544.png)

주로 Imbalance한 데이터들을 대상으로 근처의 데이터를 생성하여 데이터 증강

- Dropout

![Dropout 예시](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414162859938.png)

> ![image-20210414162852268](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414162852268.png)
...
![Train Validation Test 데이터셋](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414203049238.png)
...
![Hold-out validation의 그림](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414205220664.png)

Hold-out validation은 하나의 고정된 Validation set을 지정하는 방식이다.



![Random sampling의 그림](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414205254076.png)
...
![Stratified validation](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414205322654.png)
...
![Cross Validation의 예시](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414210940134.png)
...
![Stratified k-Fold Cross validation](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414211221698.png)

Lable의 비율을 맞추고 k개로 나누는 방법, 많이 사용함.

![Group K-Fold Cross validation](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414211236264.png)

Group(label이 혼재되어 있음)들을 하나의 덩어리로 생각하고 같은 fold에는 들어가지 않도록 Split 함, Group의 수는 언제나 fold의 수 k보다 커야한다.

![Time series split](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414211717712.png)
...
![랜덤 시드 고정 방법](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414214802775.png)

### Machine learning workflow

![머신 러닝 workflow](C:\Users\roadv\Desktop\AI_boostcamp\BoostCamp AI TIL\Pstage\정형데이터_분류\정형데이터_분류.assets\image-20210414214831525.png)